...
#define MENU_BTN 15  //long press SOS
#define PAGE_BTN 5
#define BEEPER 47
...
#define BIT_SSN (1 << 2)  // Bit 2              // greeting,confirm,tunnel,meetingJoin
...
#define BIT_SPH (1 << 7)  // Bit 7              // speech
...
#define ALT 2  // alert : direction{up/down/upAck/downAck},dstMac_6/srcMac_6,firstRelayMac,type{alert/SOS/locate(beeper & flash 2812)/ackLocate/notify},json
#define SSN 4  // session
...
extern uint8_t ApMAC[6];  //MAC address of AP

extern uint8_t ContactMAC[6];  //emergency contact  MAC
//-------------------------------------------------------software
...
extern volatile bool TurnOnWifi;   //AP / STA
...
extern TaskHandle_t sosTaskHandle;
extern TaskHandle_t oledTaskHandle;
extern TaskHandle_t max3010xTaskHandle;


extern TaskHandle_t listenTaskHandle;
extern TaskHandle_t phoneTaskHandle;
...
extern volatile uint16_t LastMeetingA;  // last meeting id for active
extern volatile uint16_t LastMeetingB;  // last meeting id for active
